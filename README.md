...
keygen1-  more advanced than keygen.  deterministic keygen from 1 byte to 20gb There are a few top ways to do this sort of thing, this way is in the top few. 
